...
${OBJECTDIR}/src/Algorithms/GA/GA_PDPPBO.o: src/Algorithms/GA/GA_PDPPBO.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Algorithms/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Algorithms/GA/GA_PDPPBO.o src/Algorithms/GA/GA_PDPPBO.cpp
...
${OBJECTDIR}/src/Algorithms/PSO/PSO.o: src/Algorithms/PSO/PSO.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Algorithms/PSO/PSO.o src/Algorithms/PSO/PSO.cpp

${OBJECTDIR}/src/Algorithms/PSO/ParticlePSO.o: src/Algorithms/PSO/ParticlePSO.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Algorithms/PSO
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Algorithms/PSO/ParticlePSO.o src/Algorithms/PSO/ParticlePSO.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/DRE2BR.o: src/ResourceAllocation/RegeneratorAssignment/DRE2BR.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/DRE2BR.o src/ResourceAllocation/RegeneratorAssignment/DRE2BR.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/FirstLongestReach.o: src/ResourceAllocation/RegeneratorAssignment/FirstLongestReach.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/FirstLongestReach.o src/ResourceAllocation/RegeneratorAssignment/FirstLongestReach.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/FirstNarrowestSpectrum.o: src/ResourceAllocation/RegeneratorAssignment/FirstNarrowestSpectrum.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/FirstNarrowestSpectrum.o src/ResourceAllocation/RegeneratorAssignment/FirstNarrowestSpectrum.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MaximumRegeneration.o: src/ResourceAllocation/RegeneratorAssignment/MaximumRegeneration.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MaximumRegeneration.o src/ResourceAllocation/RegeneratorAssignment/MaximumRegeneration.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumRegeneration.o: src/ResourceAllocation/RegeneratorAssignment/MinimumRegeneration.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumRegeneration.o src/ResourceAllocation/RegeneratorAssignment/MinimumRegeneration.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMaxReg.o: src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMaxReg.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMaxReg.o src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMaxReg.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMinReg.o: src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMinReg.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMinReg.o src/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMinReg.cpp
...
${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/RegeneratorAssignment.o: src/ResourceAllocation/RegeneratorAssignment/RegeneratorAssignment.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/RegeneratorAssignment/RegeneratorAssignment.o src/ResourceAllocation/RegeneratorAssignment/RegeneratorAssignment.cpp
...
${OBJECTDIR}/src/SimulationType/SimulationPSO.o: src/SimulationType/SimulationPSO.cpp
	${MKDIR} -p ${OBJECTDIR}/src/SimulationType
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SimulationType/SimulationPSO.o src/SimulationType/SimulationPSO.cpp
